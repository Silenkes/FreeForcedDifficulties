...
#include "CPP_IncreasingWeaponComponent.generated.h"

UCLASS()
class PROJECTDIAMOND_API UCPP_IncreasingWeaponComponent : public USkeletalMeshComponent, public ICPPI_WeaponHandler
{
	GENERATED_BODY()
...
protected:
	...
	//* Make the weapon Fire and inreases the size of the shapes hit by the weapon;
